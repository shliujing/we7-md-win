	...
	<body style="background-color:#28b0e4;">
		<div class="container">
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.we7.cc"><b>微擎</b></a> x1.6.9 &copy; 2014 <a href="http://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
...
function tpl_install_finish() {
	...
	<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> 加入QQ群一起来学习微信运营吧！　<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=aff71485451ff541924a55d62703d5dd828a600e393753dac8b91fa8dfb6689c"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="微信公众号运营交流群" title="微信公众号运营交流群"></a></div>

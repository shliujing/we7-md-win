				...
				<div class="panel-body">
					...
					<div class="wxapp-creat-select we7-padding clearfix">
						...
						<div class="col-sm-6">
							...
							<div class="con">
								打包生成小程序，选择一个公众号应用打包为小程序
							</div>
							<div>
								<a href="<?php  echo url('wxapp/post/post', array('design_method' => WXAPP_MODULE, 'uniacid' => $uniacid, 'create_type'=>WXAPP_CREATE_MODULE))?>" class="btn btn-primary">打包小程序</a>
							</div>
						</div>
					...
					<div class="wxapp-creat-select we7-padding clearfix">
						...
						<div class="col-sm-6">
							...
							<div class="con">
								打包生成小程序，选择多个公众号应用打包为小程序
							</div>
							<div>
								<a href="<?php  echo url('wxapp/post/post', array('design_method' => WXAPP_MODULE, 'uniacid' => $uniacid, 'create_type'=>WXAPP_CREATE_MUTI_MODULE, 'muti'=>1))?>" class="btn btn-primary">打包小程序</a>
							</div>
						</div>
